<div id="wrapper">
           ...
           <img src="../images/administrator-256.png" height="100px" >Nama : Sutarmo           
             <ul class="nav nav-pills nav-stacked" id="navi">
                    <li role="presentation" ><a href="index.php" class="active"><button type="button" class="btn btn-primary btn-lg btn-block">Profil</button></a></li>
