<div id="wrapper">
            ...
            <div class="sidebar"  >
            <div id="profil" style="min-height: 501px">
           <img src="../images/administrator-256.png" height="100px" >Nama : Admin           
             <ul class="nav nav-pills nav-stacked" id="navi">
                    ...
                    <li role="presentation" ><a href="mengelola_cabang.php"><button type="button" class="btn btn-primary btn-lg btn-block">Data Cabang</button></a></li>
                     ...
                     <nav id="primary_nav_wrap" style="margin-left: 11pt">
                       <ul>
                          <li role="presentation"><button type="button" class="btn btn-primary btn-lg btn-block"><a href="#">Laporan</a></button>
                            <ul>
                              <li class="btn btn-primary btn-lg btn-block"><a href="laporanbarangadmin.html"><h5>Laporan Pengiriman Barang</h5></a></li>
                              <li class="btn btn-primary btn-lg btn-block"><a href="laporanpendapatan.html"><h5>Laporan Pendapatan</h5></a></li>
                             </ul>
                          </li>
                        </ul>
                    </nav>
