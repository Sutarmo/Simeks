<div id="page-wrapper">
                <div class="container-fluid" id="container">
                    ...
                    <div class="row">
                    <div class="col-sm-12">
                        <form class="form-horizontal" role="form" action="mengelola_cabang.php">
                            <div class="form-group">
                                <label for="Id_Kurir" class="col-sm-3">Id_Cabang</label>
                                    <div class="col-sm-5">
                                        <input type="char" class="form-control" id="Nama" placeholder="">
                                    </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="telp" class="col-sm-3">Telepon</label>
                                    <div class="col-sm-5">
                                        <input type="char" class="form-control" id="telp" placeholder="">
                                    </div>
                            </div>
